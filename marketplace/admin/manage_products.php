...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="mt-2 text-gray-600">Manage marketplace inventory and pricing</p>
        </div>
        <div class="mt-4 md:mt-0">
            <a href="<?php echo BASE_URL; ?>/marketplace/admin/add_product.php" 
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo array_sum(array_column($products, 'stock')); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        ₦<?php echo count($products) > 0 ? number_format(array_sum(array_column($products, 'price')) / count($products)) : 0; ?>
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php foreach ($products as $product): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo $product['stock']; ?> units</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
